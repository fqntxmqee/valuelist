...
/** Sets a <code>Integer</code> on a <code>Query</code>. Conversion from a string is provided using <code>Integer.parseInt()</code>.
 * 
...
public class IntegerSetter extends AbstractSetter
{
   ...
   public void set(Query query, String key, Object value) throws HibernateException, ParseException
   {
      ...
      {
         throw new IllegalArgumentException("Cannot convert value of class " + value.getClass().getName() + " to int (key=" + key + ")");
      }
   }
}